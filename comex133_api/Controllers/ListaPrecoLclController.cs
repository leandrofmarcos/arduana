...
public class ListaPrecoLclController : ControllerBase
{
    ...
    private readonly IValidator<CreateListaPrecoLclRequest>  _createValidator;
    private readonly IValidator<UpdateListaPrecoLclRequest>  _updateValidator;

    public ListaPrecoLclController(
        ListaPrecoLclService service,
        IValidator<CreateListaPrecoLclRequest> createValidator,
        IValidator<UpdateListaPrecoLclRequest> updateValidator)
    {
        _service         = service;
    ...
    public async Task<IActionResult> Create([FromBody] CreateListaPrecoLclRequest request)
    {
    ...
    [HttpPut("{id:int}")]
    [Authorize(Roles = "Administrador,Gerente")]
    public async Task<IActionResult> Update(int id, [FromBody] UpdateListaPrecoLclRequest request)
    {
    ...
    public async Task<IActionResult> SetAtivo(int id, [FromBody] AtivoRequest request)
    {
        ...
        return Ok(ApiResponse.Ok(message: $"Item de Lista LCL {(request.Ativo ? "ativado" : "desativado")} com sucesso."));
    }
    ...
    public async Task<IActionResult> Delete(int id)
    {
        ...
        return Ok(ApiResponse.Ok(message: "Item de Lista LCL removido com sucesso."));
    }
}
