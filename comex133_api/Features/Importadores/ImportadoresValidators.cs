...
public class CreateImportadorValidator : AbstractValidator<CreateImportadorRequest>
{
    public CreateImportadorValidator()
    {
...
public class UpdateImportadorValidator : AbstractValidator<UpdateImportadorRequest>
{
    public UpdateImportadorValidator()
    {
        RuleFor(x => x.RazaoSocial)
            .NotEmpty().WithMessage("Razão Social é obrigatória.")
            .MaximumLength(200).WithMessage("Razão Social deve ter no máximo 200 caracteres.");
